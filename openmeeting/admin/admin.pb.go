...
func (x *UserLoginReq) Reset() {
	*x = UserLoginReq{}
	mi := &file_openmeeting_admin_admin_proto_msgTypes[0]
...
func (*UserLoginReq) Descriptor() ([]byte, []int) {
	return file_openmeeting_admin_admin_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserLoginResp) Reset() {
	*x = UserLoginResp{}
	mi := &file_openmeeting_admin_admin_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserLoginResp) Descriptor() ([]byte, []int) {
	return file_openmeeting_admin_admin_proto_rawDescGZIP(), []int{1}
}
...
func (x *UserRegisterReq) Reset() {
	*x = UserRegisterReq{}
	mi := &file_openmeeting_admin_admin_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserRegisterReq) Descriptor() ([]byte, []int) {
	return file_openmeeting_admin_admin_proto_rawDescGZIP(), []int{2}
}
...
func (x *UserRegisterResp) Reset() {
	*x = UserRegisterResp{}
	mi := &file_openmeeting_admin_admin_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserRegisterResp) Descriptor() ([]byte, []int) {
	return file_openmeeting_admin_admin_proto_rawDescGZIP(), []int{3}
}

var File_openmeeting_admin_admin_proto protoreflect.FileDescriptor

const file_openmeeting_admin_admin_proto_rawDesc = "" +
	"\n" +
	"\x1dopenmeeting/admin/admin.proto\x12\x11openmeeting.admin\"D\n" +
	...
	"\x10userRegisterRespB7Z5github.com/lvzhouzhijun/im-protocol/openmeeting/adminb\x06proto3"

var (
	file_openmeeting_admin_admin_proto_rawDescOnce sync.Once
	file_openmeeting_admin_admin_proto_rawDescData []byte
)

func file_openmeeting_admin_admin_proto_rawDescGZIP() []byte {
	file_openmeeting_admin_admin_proto_rawDescOnce.Do(func() {
		file_openmeeting_admin_admin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_openmeeting_admin_admin_proto_rawDesc), len(file_openmeeting_admin_admin_proto_rawDesc)))
	})
	return file_openmeeting_admin_admin_proto_rawDescData
}

var file_openmeeting_admin_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_openmeeting_admin_admin_proto_goTypes = []any{
...
var file_openmeeting_admin_admin_proto_depIdxs = []int32{
...
func init() { file_openmeeting_admin_admin_proto_init() }
func file_openmeeting_admin_admin_proto_init() {
	if File_openmeeting_admin_admin_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_openmeeting_admin_admin_proto_rawDesc), len(file_openmeeting_admin_admin_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_openmeeting_admin_admin_proto_goTypes,
		DependencyIndexes: file_openmeeting_admin_admin_proto_depIdxs,
		MessageInfos:      file_openmeeting_admin_admin_proto_msgTypes,
	}.Build()
	File_openmeeting_admin_admin_proto = out.File
	file_openmeeting_admin_admin_proto_goTypes = nil
	file_openmeeting_admin_admin_proto_depIdxs = nil
}
