...
import (
	sdkws "github.com/lvzhouzhijun/im-protocol/sdkws"
...
type DeleteConversationsReq struct {
	...
	ConversationIDs []string               `protobuf:"bytes,3,rep,name=conversationIDs,proto3" json:"conversationIDs"` // optional
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_conversation_conversation_proto_rawDesc = "" +
	...
	"\x13DeleteConversations\x12+.openim.conversation.DeleteConversationsReq\x1a,.openim.conversation.DeleteConversationsRespB2Z0github.com/lvzhouzhijun/im-protocol/conversationb\x06proto3"
